...
public class PhotoServiceReviewController {
    ...
    public ResponseEntity<ApiUtil<Page<PhotoServiceReviewResponse.ListDTO>>> getReviewsByPhotographer(
        ...
        Page<PhotoServiceReviewResponse.ListDTO> response =
                reviewService.getReviewsByPhotographer(photographerId, pageable);
        return ResponseEntity.ok(new ApiUtil<>(response));
    }
}
